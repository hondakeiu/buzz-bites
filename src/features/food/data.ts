...
export const foods: Category[] = [
  {
    ...
    items: [
      ...
      { name: "小麦粉", date: null, status: null },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "トマト", date: null, status: null },
  ...
  },
  {
    ...
    id: "meat",
    items: [
      { name: "鶏むね肉", date: null, status: null },
  ...
  },
  {
    ...
    id: "fish",
    items: [
      { name: "まぐろ", date: null, status: null },
      { name: "サーモン", date: null, status: null },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "牛乳", date: null, status: null },
      { name: "ヨーグルト", date: "2025-02-10", status: "好き" },
      { name: "バター", date: null, status: null },
